...
- **Copiloto de sessão:** protótipo supervisionado. A aprovação é bloqueada se o código não for A1–A6/B1–B7, se houver exercício fora da biblioteca fechada ou se um bloqueio clínico tentar liberar sessão diferente de A5/A6/B7. A chave Anthropic fica somente na sessão da aba. **Ainda não é arquitetura de produção**: a chamada à Anthropic continua sendo feita pelo navegador.
