...
// em PT-BR (o mesmo usado em COPILOTO_EXERCISES, js/app.js), id (slug kebab-case
// do banco) e grupo (pra agrupar o seletor de exercício no formulário manual de
// sessão). Não adicionar item aqui sem primeiro existir na tabela.
export const EXERCISE_LIBRARY = [
  ['centro', 'estabilidade lateral ajoelhado', 'estabilidade-lateral-ajoelhado'],
  ['centro', 'estabilidade lateral em pé', 'estabilidade-lateral-em-pe'],
  ['centro', 'cortador ajoelhado', 'cortador-ajoelhado'],
  ['centro', 'prancha semiajoelhada', 'prancha-semiajoelhada'],
  ['centro', 'prancha no chão', 'prancha-no-chao'],
  ['centro', 'prancha na bola', 'prancha-na-bola'],
  ['centro', 'prancha no slide', 'prancha-no-slide'],
  ['centro', 'ponte na bola', 'ponte-na-bola'],
  ['centro', 'flexão de joelhos na bola', 'flexao-joelhos-bola'],
  ['centro', 'flexão de joelhos no slide', 'flexao-joelhos-slide'],
  ['membros-inferiores', 'goblet squat', 'goblet-squat'],
  ['membros-inferiores', 'double front squat', 'double-front-squat'],
  ['membros-inferiores', 'agachamento com barra', 'agachamento-barra'],
  ['membros-inferiores', 'passada simples', 'passada-simples'],
  ['membros-inferiores', 'passada 2 steps', 'passada-2-steps'],
  ['membros-inferiores', 'passada com suspensão', 'passada-suspensao'],
  ['membros-inferiores', 'terra kettlebell', 'terra-kettlebell'],
  ['membros-inferiores', 'terra hexagonal', 'terra-hexagonal'],
  ['membros-inferiores', 'terra com barra', 'terra-barra'],
  ['membros-superiores', 'apoio', 'apoio'],
  ['membros-superiores', 'supino halter', 'supino-halter'],
  ['membros-superiores', 'supino com barra', 'supino-barra'],
  ['membros-superiores', 'empurrar barra semiajoelhado', 'empurrar-barra-semiajoelhado'],
  ['membros-superiores', 'supino inclinado', 'supino-inclinado'],
  ['membros-superiores', 'double press', 'double-press'],
  ['membros-superiores', 'face pull', 'face-pull'],
  ['membros-superiores', 'puxada inclinada', 'puxada-inclinada'],
  ['membros-superiores', 'barra fixa', 'barra-fixa'],
  ['lancamentos', 'arremesso med ball af semiajoelhado', 'mb-af-semiajoelhado'],
  ['lancamentos', 'arremesso med ball af em pé', 'mb-af-em-pe'],
  ['lancamentos', 'arremesso med ball af base contralateral', 'mb-af-contralateral'],
  ['lancamentos', 'arremesso med ball ac semiajoelhado', 'mb-ac-semiajoelhado'],
  ['lancamentos', 'arremesso med ball ac em pé', 'mb-ac-em-pe'],
  ['lancamentos', 'arremesso med ball ac base contralateral', 'mb-ac-contralateral'],
  ['pliometria', 'pogo jump vertical', 'pogo-vertical'],
  ['pliometria', 'pogo jump lateral', 'pogo-lateral'],
  ['pliometria', 'pogo jump frente/trás', 'pogo-frente-tras'],
  ['pliometria', 'pogo jump unilateral', 'pogo-unilateral'],
  ['pliometria', 'queda no solo bilateral', 'queda-solo-bilateral'],
  ['pliometria', 'queda no solo assimétrica', 'queda-solo-assimetrica'],
  ['pliometria', 'queda da caixa bilateral', 'queda-caixa-bilateral'],
  ['pliometria', 'queda da caixa assimétrica', 'queda-caixa-assimetrica'],
  ['pliometria', 'hop linear dc', 'hop-linear-dc'],
  ['pliometria', 'hop linear contínuo', 'hop-linear-continuo'],
  ['pliometria', 'hop lateral contínuo', 'hop-lateral-continuo'],
  ['pliometria', 'bound contínuo', 'bound-continuo'],
  ['pliometria', 'bound lateral dp', 'bound-lateral-dp'],
  ['pliometria', 'bound contínuo com sobrecarga', 'bound-continuo-sobrecarga'],
  ['pliometria', 'drop vertical bilateral', 'drop-vertical-bilateral'],
  ['pliometria', 'drop vertical barreira', 'drop-vertical-barreira'],
  ['pliometria', 'drop diagonal barreira', 'drop-diagonal-barreira'],
  ['areia-cod', 'load and lift', 'load-and-lift'],
  ['areia-cod', 'lateral shuffle', 'lateral-shuffle'],
  ['areia-cod', 'double shuffle', 'double-shuffle'],
  ['areia-cod', 'cut and shuffle', 'cut-and-shuffle'],
  ['areia-cod', 'lateral shuffle contínuo', 'lateral-shuffle-continuo'],
  ['areia-cod', 'lean and crossover', 'lean-and-crossover'],
  ['areia-cod', 'crossover potente', 'crossover-potente'],
  ['areia-cod', 'cut and crossover', 'cut-and-crossover'],
  ['areia-aceleracao', 'load and lift com alternância de pernas', 'load-and-lift-alternancia'],
  ['areia-aceleracao', 'marcha contra a parede', 'marcha-contra-parede'],
  ['areia-aceleracao', 'marcha à frente com resistência', 'marcha-frente-resistencia'],
  ['areia-aceleracao', 'skip com resistência', 'skip-resistencia'],
  ['areia-aceleracao', 'bound com resistência', 'bound-resistencia'],
  ['areia-aceleracao', 'corrida resistida', 'corrida-resistida'],
  ['areia-aceleracao', 'utilização de trenós', 'treno'],
].map(([grupo, nome, id]) => ({ grupo, nome, id }));

export const EXERCISE_GROUP_LABELS = {
  'centro': 'Centro do corpo', 'membros-inferiores': 'Membros inferiores',
  'membros-superiores': 'Membros superiores', 'lancamentos': 'Potência / lançamentos',
  'pliometria': 'Pliometria', 'areia-cod': 'Areia — mudança de direção',
  'areia-aceleracao': 'Areia — aceleração',
};
