...
export function athleteProfile() {
  ...
  return `<div class="pagepad">
    ...
    <div class="card" style="display:flex;flex-direction:column;gap:1px;border-radius:16px;overflow:hidden;">
      <div class="tap" data-action="athlete-anamnese-edit" style="display:flex;align-items:center;gap:13px;padding:15px;"><svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#8A94A3" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4-6 8-6s8 2 8 6"/></svg><span style="flex:1;font-size:14.5px;">Meus dados de treino</span>${ICONS.chev}</div>
