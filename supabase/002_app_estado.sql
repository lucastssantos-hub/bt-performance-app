...
-- Projeto compartilhado btjsweysefmbceqqlyxx (BeachFlow + Copa + BT). Aplicar via
-- migração no repo da Copa (copa-vite/supabase/migrations/20260611120000_bt_app_estado.sql,
-- cópia idêntica deste arquivo) ou colar no SQL Editor.
