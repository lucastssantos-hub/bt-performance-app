...
B4 Potência rotacional (academia) — 2–4×3–6 por lado, máxima intenção de velocidade, bola leve/moderada, descanso 60–120s (mesma dose pra qualquer exercício desta sessão, sem diferença entre principal e complementar). Quando: déficit em arremesso med ball, golpe perde potência por falta de transferência, sem dor lombar/ombro. Principal (1–2): arremesso med ball af semiajoelhado/em pé/base contralateral, arremesso med ball ac semiajoelhado/em pé/base contralateral. Complementar opcional (até 2): cortador ajoelhado, estabilidade lateral em pé. Progressão: semiajoelhado → em pé → base contralateral.
